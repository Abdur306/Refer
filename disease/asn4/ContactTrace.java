...
//		DiseaseControlManager dcm=new DiseaseControlManagerImpl(3,3);
//		Patient p1=dcm.addPatient("anil", "sunil", 2, 1);
//		Exposure ex1=new Exposure(p1.getPatientId());
//		ex1.setDateTime(LocalDateTime.of(2023,5,20,10,30,0));
...
//		ex3.setDateTime(LocalDateTime.of(2023,4,21,10,30,0));
//		ex3.setExposureType("D");
//		
//		
//		p1.setExposures(new Exposure[] {ex2,ex1});
//		p2.setExposures(new Exposure[] {ex3});
//		p3.setExposures(new Exposure[] {ex2});
//		
//		ContactTrace ct=new ContactTrace(dcm);
//		
//		PatientZero pzero=ct.findPatientZero(p3);
//		
